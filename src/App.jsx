...
const MATH_IMG_1 = "https://github.com/user-attachments/assets/a8da1f49-be7c-4f35-8aa9-f01e5809aebb";
const MATH_IMG_2 = "https://github.com/user-attachments/assets/ee2957cd-4174-4b97-a980-fd0cd8a568aa";
        ...
        {page === 'education' && (
          <div className="max-w-4xl mx-auto space-y-24 animate-in slide-in-from-right duration-700">
            ...
            <div className="space-y-8 relative">
                ...
                <div className="space-y-6 border-l-2 border-white/10 pl-6">
                  <div>
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <span className="text-[9px] uppercase tracking-widest text-white/40">Oct 2025</span>
                    </div>
                  ...
                  <div>
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <span className="text-[9px] uppercase tracking-widest text-white/40">Nov 2025-Ongoing</span>
                    </div>
              ...
              <div className="p-8 border border-white/10 bg-white/[0.02] relative">
                <Corners />
                <h4 className="text-xl font-black uppercase italic tracking-tighter mb-4">Social Studies</h4>
                <p className="text-sm text-white/60">Add your social studies content here...</p>
              </div>

              <div className="p-8 border border-white/10 bg-white/[0.02] relative">
                <Corners />
                <h4 className="text-xl font-black uppercase italic tracking-tighter mb-4">Art</h4>
                <p className="text-sm text-white/60">Add your art content here...</p>
              </div>

              <div className="p-8 border border-white/10 bg-white/[0.02] relative">
                <Corners />
                <h4 className="text-xl font-black uppercase italic tracking-tighter mb-4">Physical Education</h4>
                <p className="text-sm text-white/60">Add your phys ed content here...</p>
              </div>

              <div className="p-8 border border-white/10 bg-white/[0.02] relative">
                <Corners />
                <h4 className="text-xl font-black uppercase italic tracking-tighter mb-4">Geography</h4>
                <p className="text-sm text-white/60">Add your geography content here...</p>
              </div>

              <div className="p-8 border border-white/10 bg-white/[0.02] relative">
                <Corners />
                <h4 className="text-xl font-black uppercase italic tracking-tighter mb-4">Science</h4>
                <p className="text-sm text-white/60">Add your science content here...</p>
              </div>
